...
Remember that AWS (and other cloud providers) will charge you for using their service. How much depends on several factors. Read on 0 and be informed!
...
> Note: Free tier includes: t2.micro, t3.micro, t4g.micro, and flex instances. (But this could change at any time!)
