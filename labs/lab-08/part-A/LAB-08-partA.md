# ⚙️ Lab-08A - Building a Shared Local Module
...
- terraform block with a required version of 1.14.2.
...
> Note:If you created a second user, be sure to check that user's AWS region and destroy any additional instances associated with that user, or any other users. 
