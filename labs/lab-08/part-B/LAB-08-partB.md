# ⚙️ Lab-08B - Working with Public Modules
...
That should create a three instance cluster of servers. I might take several minutes to complete. Watch the log for any errors or stops.
...
> Note: This lab is using Amazon Linux. If you ever want to find out more information about an AWS AMI use the following command:
>
>`aws ec2 describe-images --image-ids <AMI_image_ID> --region "us-east-2"`
