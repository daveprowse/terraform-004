# ⚙️ Lab 16 - Working with the Terraform Cloud (TC)

In this lab we'll:
- Create a Terraform Cloud (TC) account
- Create a workspace
- Complete a Terraform run in the TC using the CLI
- Conquer the world! (Well... at least our little section of it! 😁)

## Pre-Work

### Create a TC account

https://app.terraform.io/login/new

> Note: Later, you can sign in at: https://app.terraform.io

You will need a valid email address to validate your account.

> Note: You will also need to use a strong password. Might I suggest KeePass, a KeePass derivative, BitWarden, or other similar locally stored password vault.
...
### Observe the Terraform Cloud Website

Spend a couple minutes or so taking a look at the Terraform Cloud website, including the main components, settings, and documentation.
