...
- Apply the infrastructure. You should be asked for a name for the instance, because there is no default. Type this directly in the terminal. Remember the name you choose.
